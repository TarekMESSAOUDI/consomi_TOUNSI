...
public class BillServiceImpl implements BillService {
	...
	@Override
		public void billpdf (Long idBill){
		 ...
		 document.add(new Paragraph("Destinataire :   "+b.getOrder().getClient().getFirstNameUser()));
		 SimpleDateFormat formater = null;
		 formater = new SimpleDateFormat("dd-MM-yy");
		
		 Paragraph adresse=new Paragraph("Adresse : "+b.getOrder().getClient().getAdressUser()+"                                                                                  Date de commande : "+b.getOrder().getDateOrder());
		 document.add(adresse);
	
		 document.add(new Paragraph("Numéro de téléphone :  "+b.getOrder().getClient().getPhoneNumberUser()));
		 ...
		 PdfPCell name = new PdfPCell(new Paragraph("Product", tableHeader));
		    ...
		    PdfPCell nameProduit = new PdfPCell(new Paragraph("idProduct", tableHeader));
		    ...
		    PdfPCell quantiteval = new PdfPCell(new Paragraph(String.valueOf(b.getOrder().getProduct().getTitleProduct()) , tableHeader));
	 	    ...
	 	    PdfPCell produiteval = new PdfPCell(new Paragraph(String.valueOf(b.getOrder().getProduct().getBarcodeProduct()), tableHeader));
	 	    ...
	 	    PdfPCell prixval = new PdfPCell(new Paragraph(String.valueOf(b.getOrder().getProduct().getPriceProduct()), tableHeader));
