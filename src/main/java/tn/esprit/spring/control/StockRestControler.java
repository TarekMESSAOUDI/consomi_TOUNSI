...
public class StockRestControler {
	...
	// http://localhost:8081/SpringMVC/servlet/retrieve-all-Stocks
	...
	//localhost:8081/SpringMVC/servlet/retrieve-stock/{stock-id}
		...
		//localhost:8081/SpringMVC/servlet/remove-stock/{stock-id}
